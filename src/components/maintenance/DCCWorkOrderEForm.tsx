      ...
      <div className="dcc-eform-page max-w-[210mm] mx-auto bg-white border border-stone-300 shadow-2xl p-6 sm:p-8 rounded-xl print:shadow-none print:border-none print:p-0 print:m-0 print:w-full print:max-w-none">
        ...
        <div className="border-2 border-black divide-y-2 divide-black text-xs">
          <div className="grid grid-cols-12 divide-x-2 divide-black">
            {/* Logo / Company */}
            <div className="col-span-3 p-3 print:p-2 flex flex-col justify-center items-center text-center bg-stone-50 print:bg-white">
            ...
            {/* Document Title */}
            <div className="col-span-6 p-3 print:p-2 flex flex-col justify-center items-center text-center">
            ...
            <div className="col-span-3 p-2 print:p-1.5 text-[10px] space-y-1 print:space-y-0.5 bg-stone-50 print:bg-white font-mono">
        ...
        {/* WO Number Bar */}
        <div className="flex items-center justify-between border-x-2 border-b-2 border-black p-2 print:p-1.5 bg-stone-100 print:bg-stone-100 text-xs font-mono">
          <div>
        ...
        ========================================================================= */}
        <div className="border-x-2 border-b-2 border-black p-3 print:p-2 space-y-2 print:space-y-1.5 text-xs">
          <div className="font-bold text-stone-900 uppercase tracking-wider text-[11px] bg-stone-200 print:bg-stone-200 px-2 py-1 print:py-0.5 flex items-center justify-between">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 print:gap-1.5 pt-1">
            <div>
        ...
        ========================================================================= */}
        <div className="border-x-2 border-b-2 border-black p-3 print:p-2 space-y-2 print:space-y-1.5 text-xs">
          <div className="font-bold text-stone-900 uppercase tracking-wider text-[11px] bg-stone-200 print:bg-stone-200 px-2 py-1 print:py-0.5">
            ส่วนที่ 2: การตรวจสอบและดำเนินการซ่อมบำรุง (Maintenance Diagnosis & Corrective Action)
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 print:gap-1.5 pt-1 font-mono">
            <div>
          ...
          <div className="grid grid-cols-2 gap-2 print:gap-1.5 pt-2 print:pt-1 border-t border-stone-200">
            <div>
        ...
        <div className="border-x-2 border-b-2 border-black text-xs">
          <div className="font-bold text-stone-900 uppercase tracking-wider text-[11px] bg-stone-200 print:bg-stone-200 px-3 py-1 print:py-0.5 border-b-2 border-black flex justify-between">
          ...
          {parts.length === 0 ? (
            <div className="p-3 print:p-2 text-center text-stone-500 italic text-[11px]">
            ...
            <table className="w-full text-left border-collapse text-[11px]">
              <thead>
                <tr className="bg-stone-100 print:bg-stone-100 border-b border-black font-semibold">
                  <th className="p-1.5 print:p-1 pl-3 print:pl-2 w-10 text-center">ลำดับ</th>
                  <th className="p-1.5 print:p-1">รหัสอะไหล่</th>
                  <th className="p-1.5 print:p-1">รายการอะไหล่</th>
                  <th className="p-1.5 print:p-1 text-center w-20">จำนวน</th>
                  <th className="p-1.5 print:p-1 text-center w-16">หน่วย</th>
                  <th className="p-1.5 print:p-1 text-right w-24">ราคา/หน่วย</th>
                  <th className="p-1.5 print:p-1 pr-3 print:pr-2 text-right w-28">ราคารวม (บาท)</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-stone-300 font-mono">
                {parts.map((p: any, i: number) => (
                  <tr key={p.id || i}>
                    <td className="p-1.5 print:p-1 pl-3 print:pl-2 text-center">{i + 1}</td>
                    <td className="p-1.5 print:p-1 font-bold">{p.part_code}</td>
                    <td className="p-1.5 print:p-1 font-sans">{p.part_name}</td>
                    <td className="p-1.5 print:p-1 text-center">{p.quantity}</td>
                    <td className="p-1.5 print:p-1 text-center font-sans">{p.unit}</td>
                    <td className="p-1.5 print:p-1 text-right">฿{Number(p.unit_cost || 0).toLocaleString()}</td>
                    <td className="p-1.5 print:p-1 pr-3 print:pr-2 text-right font-bold">฿{Number(p.total_cost || 0).toLocaleString()}</td>
                  </tr>
                ))}
                <tr className="bg-stone-50 font-bold border-t border-black">
                  <td colSpan={6} className="p-1.5 print:p-1 text-right font-sans">ต้นทุนอะไหล่รวมทั้งสิ้น:</td>
                  <td className="p-1.5 print:p-1 pr-3 print:pr-2 text-right text-stone-900">
        ...
        ========================================================================= */}
        <div className="border-x-2 border-b-2 border-black p-3 print:p-2 space-y-2 print:space-y-1 text-xs">
          <div className="font-bold text-stone-900 uppercase tracking-wider text-[11px] bg-stone-200 print:bg-stone-200 px-2 py-1 print:py-0.5">
            ส่วนที่ 4: ภาพถ่ายหลักฐานเชิงประจักษ์ (Visual Evidence - Audit Proof)
          </div>

          <div className="grid grid-cols-2 gap-4 print:gap-2.5 pt-1">
            {/* Before Photo */}
            <div className="border border-stone-300 rounded-lg p-2 print:p-1.5 text-center bg-stone-50 print:bg-white flex flex-col justify-between">
              <span className="font-bold text-stone-700 block mb-1 print:mb-0.5 text-[11px] print:text-[10px]">
                📸 ภาพถ่ายก่อนซ่อม / ตอนแจ้งเสีย (Before Repair)
              </span>
              <div className="h-36 print:h-28 w-full rounded border border-stone-200 overflow-hidden bg-stone-100 flex items-center justify-center">
                {wo.photo_before_urls && wo.photo_before_urls[0] ? (
                  /* eslint-disable-next-line @next/next/no-img-element */
                  <img src={wo.photo_before_urls[0]} alt="Before Repair" className="h-36 print:h-28 w-full object-contain" />
                ) : (
                  <span className="text-stone-400 italic text-[10px]">ไม่มีการแนบภาพถ่ายก่อนซ่อม</span>
                )}
              </div>
              <span className="text-[9px] text-stone-400 mt-1 print:mt-0.5 block">บันทึกผ่านระบบดิจิทัลขณะแจ้งซ่อม</span>
            </div>
            ...
            <div className="border border-stone-300 rounded-lg p-2 print:p-1.5 text-center bg-stone-50 print:bg-white flex flex-col justify-between">
              ...
              <div className="h-36 print:h-28 w-full rounded border border-stone-200 overflow-hidden bg-stone-100 flex items-center justify-center">
                {wo.photo_after_urls && wo.photo_after_urls[0] ? (
                  /* eslint-disable-next-line @next/next/no-img-element */
                  <img src={wo.photo_after_urls[0]} alt="After Repair" className="h-36 print:h-28 w-full object-contain" />
                ) : (
                  <span className="text-stone-400 italic text-[10px]">ไม่มีการแนบภาพถ่ายหลังซ่อม</span>
                )}
              </div>
              <span className="text-[9px] text-stone-400 mt-1 print:mt-0.5 block">บันทึกผ่านระบบดิจิทัลขณะส่งมอบงาน</span>
            </div>
          </div>
        </div>
        ...
        <div className="border-2 border-t-0 border-black p-3 print:p-2 space-y-3 print:space-y-1.5 text-xs">
          ...
          <div className="grid grid-cols-3 gap-3 print:gap-2 pt-1.5 print:pt-1">
            {/* Box 1: Technician */}
            <div className="border border-black p-2.5 print:p-1.5 rounded text-center space-y-2 print:space-y-1 bg-stone-50/50">
              <span className="font-bold text-[10px] text-stone-700 uppercase block border-b border-stone-200 pb-1 print:pb-0.5">
          ...
          {/* Footer Audit Stamp */}
          <div className="pt-2 print:pt-1.5 flex items-center justify-between text-[10px] print:text-[9px] text-stone-500 border-t border-stone-200 font-mono">
            <div>
